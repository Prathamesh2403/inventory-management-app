...
//             </Link>
//             <div>
//               <h1 className="text-3xl font-bold text-white">Edit Retro Product</h1>
//               <p className="text-cyan-300 text-sm">Update your vintage electronics</p>
//             </div>
//           </motion.div>
...
//                 Product Details
//               </h2>
//               <p className="text-cyan-300 mt-1">Update your retro tech specifications</p>
//             </div>
...
//                       placeholder="e.g., Vintage Game Boy"
//                     />
//                   </motion.div>
...
//                       placeholder="Describe your retro tech product..."
//                     />
//                   </motion.div>
//                 </div>
...
//                   type="submit"
//                   disabled={isSaving}
//                   className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-lg font-medium hover:from-cyan-600 hover:to-blue-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
//                 >
//                   {isSaving ? (
//                     <>
//                       <motion.div
...
const EditProductPage = () => {
  ...
  const submitHandler = async (e) => {
    ...
    setIsSaving(true);
    try {
      await apiClient.put(`/api/products/${productId}`, formData);
          ...
          >
            ...
            <div>
              ...
              <p className="text-cyan-300 text-sm">
                Update your vintage electronics
              </p>
            </div>
          </motion.div>
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-xl overflow-hidden">
            <div className="p-6 border-b border-white/20">
              ...
              <p className="text-cyan-300 mt-1">
                Update your retro tech specifications
              </p>
            </div>
